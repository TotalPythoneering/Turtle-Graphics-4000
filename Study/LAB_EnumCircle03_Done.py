...
# DATE: 2018-07-18 07:05:40
# FILE: LAB_EnumCircle03_Done.py
# AUTHOR: Randall Nagy
# LAB_EnumCircle03_Done.py
#

import turtle
from StateSaver.EnumPoly import Enumerator as E1
from StateSaver.EnumCircle import Enumerator as E2 # The Fix!
...
if __name__ == "__main__":
    ...
    turtle.pensize(4)
    dots = None
    if degrees_per is 360:
        dots = E1(len(values))
    else:
        dots = E2(len(values), degrees=degrees_per)
    ss = 0
